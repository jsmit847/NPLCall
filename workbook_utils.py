...
def format_deal_label(row: pd.Series) -> str:
    return f"{row['Deal Number']} | {row['Deal Name']} | {row['Asset Manager']}"



def build_filtered_view(base_deals: pd.DataFrame, editor_df: pd.DataFrame) -> pd.DataFrame:
