...
## v4 adjustments
- Review and presentation merged into one Review workspace tab.
- Deal name and Asset Manager display enlarged for clearer ownership during screenshare.
- Removed Next open and Next blank comment navigation.
- Workbook uploader moved to the sidebar so it does not stay in the main workspace.
